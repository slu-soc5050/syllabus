...
readings <- data.frame(
  ...
  Citation = c("Diez, D. M., Barr, C. D., & Cetinkaya-Rundel, M. (2012). OpenIntro Statistics. CreateSpace.", "Wickham, H., & Grolemund, G. (2016). R for data science: import, tidy, transform, visualize, and model data. O'Reilly Media, Inc.", "Prener, C. (2018). Sociospatial Data Science.", "Wheelan, C. (2013). Naked statistics: Stripping the dread from the data. WW Norton & Company."),
  stringsAsFactors = FALSE
)

knitr::kable(
  readings, booktabs = TRUE,
  caption = "SOC 4015 & 5050 Primary Readings"
)
```
...
```{r, echo=FALSE}
readings <- data.frame(
  Abbreviation = c("ER", "GH", "Link", "PL"),
  Citation = c("Electronic Reserves", "GitHub", "Website", "Pius Library"),
  stringsAsFactors = FALSE
)
